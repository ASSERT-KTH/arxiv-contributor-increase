...
Beyond submission counts, Gen AI's impact on arXiv raises several related questions that this dataset could partially address or motivate future work:

- **Paper quality.** Are new submitters producing papers of good quality?

- **Rise of single-author papers.** If AI tools lower the cost of writing, researchers may submit without collaborators. Is the share of single-author papers increasing?

- **Repeat submitters vs. one-time submitters.** Are new submitters returning in subsequent months, or does the growth reflect a large influx of one-time contributors?

- **Characteristics.** Are new submitters concentrated in particular countries, institutions or group, suggesting that AI tools are opening arXiv to communities previously under-represented?

- **Paper length and structure.** Are papers getting longer or shorter? AI assistance may encourage certain structural and writing patterns.
